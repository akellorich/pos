                                        ...
                                        <div class="tab-content text-left" id="nav-tabContent">
                                            <div class="tab-pane fade show active" id="pop1" role="tabpanel" aria-labelledby="pop1-tab">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div id="buttonlist" class="d-flex justify-content-around">
                                                            <button class="btn btn-primary btn-sm" id="changestatusbutton">Disable User</button>
                                                            <button class="btn btn-primary btn-sm" id="changepasswordbutton">Reset Password</button>
                                                            <button class="btn btn-primary btn-sm" id="resetpinbutton">Reset PIN</button>
                                                        </div>
                    ...
                    <div class="col">
                        <div id="userdetails" class="mt-2">
                            <div class="card containergroup">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col d-block form-group">
                                            <label for="">&nbsp;</label>
                            ...
                            <div class="d-flex justify-content-between mt-2">
                                ...
                                <div>
                                    <button class='btn btn-success btn-sm mr-2' id='saveuser'><i class="fal fa-save fa-lg"></i> Save User</button>
                                    <button class='btn btn-outline-danger btn-sm mr-2' id='clearuser'><i class="fal fa-hand-sparkles fa-lg"></i> Clear Fields</button>
                                    <button class='btn btn-outline-success btn-sm mr-2' id='adduserrole' data-toggle='modal' data-target='#userrolesadd'><i class="fal fa-plus-circle fa-lg"></i> Attach Role</button>
                                    <button class='btn btn-outline-success btn-sm mr-2' id='adduseroutlet' data-toggle='modal' data-target='#useroutletsadd'><i class="fal fa-plus-circle fa-lg"></i> Attach Outlet</button>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="defaultdatabase">Select Branch</label>
                        <select name="defaultdatabase" id="defaultdatabase" class="form-control form-control-sm">
                            <option value="">&lt;Choose&gt;</option>
                        </select>
                    </div>
                </div>
