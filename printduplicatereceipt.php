...
<div id='printContainer'>
   ...
   <hr>
    ...
    <table>
        ...
        $data2=$rst->fetchAll(PDO::FETCH_ASSOC);
        foreach($data2 as $dataitem){
            echo "<tr><td class='text-left'>". $dataitem['abbreviation']." - ".($dataitem['taxrate'])."</td><td class='text-right'><span class='numeric'>".$dataitem['total']-$dataitem['vat']."</span></td><td class='text-right'><span class='numeric'>".$dataitem['vat']."</span></td></tr>";
        ...
        <div id='receiptfooter'>
            <tr>
                <td colspan="3"><hr>Thanks for shopping with us. Please come again. Goods once sold are not returnable or refundable.<strong> Crate Deposits refundable within 7 DAYS.<strong><hr></td>
                <td></td>
            </tr>
        <div>
        <tr>
