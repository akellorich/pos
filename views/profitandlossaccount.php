...
<html lang="en" dir="ltr">
    <head>
        ...
        <title> SalesFlow | Profit and Loss Account </title>
        <style>
          /* Responsive customizations for the Profit and Loss Account page */
    ...
    <body>
        ...
        <section class="home-section">
            <?php $pagename = "Profit and Loss Account"; require_once("topbar.php"); ?>
                                ...
                                <div class="containergroup card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-end mt-2">
                                            <button type="button" class="btn btn-secondary btn-sm" id="generate" name="generate" style="min-width: 150px; font-weight: 500;">
    ...
    <script type="text/javascript" src="../js/profitandlossaccount.js"></script>
<html>