<?php 
    ...
    class db{
        ...
        function connect(){
            ...
            // $this->username="tnixjxsk_dbuser";
            // $this->password="K@r1bun1kenya";
           
           
            // production creds
            // $this->username="enetagco_posuser";
            // $this->password="K@r1bun1kenya";

             // production creds
            // $this->username="amnelsol_appuser";
            // $this->password="k@r1bun1kenya";


            // Production Cred
            // $this->username="wovijlbc_appuser";
            // $this->password="K@r1bun1kenya";
        ...
        function getcompanydetails($sql){
            ...
            $pdo1=new PDO($dsn,$this->username,$this->password);
            $pdo1->setAttribute(PDO::ATTR_ERRMODE,PDO::ERRMODE_EXCEPTION);
            return json_encode($pdo->connect()->query($sql)->fetchAll(PDO::FETCH_ASSOC));
        }
