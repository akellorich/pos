...
<html lang="en" dir="ltr">
  <head>
    ...
    <style>
      /* Responsive customizations for the Master Stocksheet Report page */
      ...
      @media (min-width: 992px) {
          ...
          /* Distribute height among the cards in the right column */
          #receiptlist > .containergroup:nth-of-type(1) {
          ...
          #receiptlist > .containergroup:nth-of-type(2) {
          ...
          #receiptlist > .containergroup:nth-of-type(3) {
              flex: 1 1 0% !important;
              display: flex !important;
              flex-direction: column !important;
              min-height: 0 !important;
          ...
          #receiptlist > .containergroup .card-body {
          ...
          /* Shrink collapsed cards to their header height, collapsing whitespace */
          #receiptlist > .containergroup:has(.card-header.collapsed) {
      ...
      /* Collapsable card header chevron rotation */
            ...
            <div class="container-fluid mt-2">
                <div class="row">
                            ...
                            <div class="containergroup card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label for="startdate" class="font-weight-bold text-muted" style="font-size: 0.8rem;">As at Date</label>
                    ...
                    <div class="col-12 col-lg-9" id="receiptlist">
                        <div class="containergroup card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-container">
                                    <table class="table table-sm table-striped table-hover mb-0" id="masterstocksheetreport">
                                        <thead></thead>
                                        <tbody></tbody>
                                    </table>
                                </div>
                        ...
                        <div class="containergroup card">
                            <div class="card-header d-flex justify-content-between align-items-center collapsed" style="cursor: pointer;" data-toggle="collapse" data-target="#returnOutwardsCollapse">
                                <h5>Return Outwards</h5>
                                <i class="fal fa-chevron-down text-muted" style="font-size: 0.8rem;"></i>
                            </div>
                            <div class="collapse" id="returnOutwardsCollapse">
                                <div class="card-body">
                                    <div class="table-container">
                                        <table class="table table-sm table-striped mb-0" id="returnoutwardssummary">
                                            <thead>
                                                <th>#</th>
                                                <th>Date</th>
                                                <th>Item Code</th>
                        ...
                        <div class="containergroup card">
                            <div class="card-header d-flex justify-content-between align-items-center collapsed" style="cursor: pointer;" data-toggle="collapse" data-target="#returnInwardsCollapse">
                                <h5>Return Inwards</h5>
                                <i class="fal fa-chevron-down text-muted" style="font-size: 0.8rem;"></i>
                            </div>
                            <div class="collapse" id="returnInwardsCollapse">
                                <div class="card-body">
                                    <div class="table-container">
                                        <table class="table table-sm table-striped mb-0" id="returninwardssummary">
                                            <thead>
                                                <th>#</th>
                                                <th>Date</th>
                                                <th>Item Code</th>
