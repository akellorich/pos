...
function index()
{
 ...
 //   $pdf->SetDirectionality('rtl'); // Set lang direction for rtl lang
    ...
    // get receipt details
    $sql="CALL `spgetreturninwardsheader`('{$id}')";
    $rst=$db->connect()->query($sql);
...
<head>
    ...
    <title>Return Inwards Form</title>
...
<div id='printContainer'>
    ...
    <div class="text-center"><b>RETURN INWARDS FORM</b></div><br/>
   
    <table>
        <tr>
            <td>Customer:<b> <?=$data1['customername']?></b></td>
            <td>Receipt #:<b> <?=$data1['receiptno']?></b></td>
        </tr>
        <tr> 
   ...
   <hr>
    <table>
        ...
        <?php 
            ...
            $sql="CALL spgetreturninwardsdetails('{$id}')";
            $rst=$db->connect()->query($sql);
