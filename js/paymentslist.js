            ...
            $.getJSON(
                "../controllers/paymentoperations.php",
                {
                    ...
                    for(var i=0;i<data.length;i++){
                        ...
                        results+="<td><a href='javascript void(0)' class='print' data-id='"+data[i].voucherid+"' data-voucherno='"+data[i].voucherno+"'><span><i class='fas fa-print fa-sm'></i></span></a></td>"
                        results+="<td><a href='javascript void(0)' class='edit' data-id='"+data[i].voucherid+"' data-voucherno='"+data[i].voucherno+"'><span><i class='fas fa-edit fa-sm'></i></span></a></td>"
