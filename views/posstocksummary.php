...
<html lang="en" dir="ltr">
  <head>
    ...
    <style>
      /* Responsive customizations for the POS Stock Summary page */
                            ...
                            <div class="containergroup card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label for="asatdate" class="font-weight-bold text-muted" style="font-size: 0.8rem;">As At Date</label>
                                        <input type="text" id="asatdate" name="asatdate" autocomplete="off" class="form-control form-control-sm">
                                    </div>

                                    <div class="form-group">
                                        <label for="category" class="font-weight-bold text-muted" style="font-size: 0.8rem;">Category</label>
                        ...
                        <div class="containergroup card">
                            ...
                            <div class="card-body card-body-list">
                                ...
                                <div class="table-container">
                                    <table class="table table-striped table-sm mb-0" id="posstocklistreport">
                                        <thead></thead>
                                        <tbody></tbody>
                                        <tfoot></tfoot>
                                    </table>
