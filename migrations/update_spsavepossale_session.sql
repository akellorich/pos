-- Update spsavepossale to include sessionid
...
BEGIN
    ...
    START TRANSACTION;
        ...
        INSERT INTO possalesdetails (branchid, possaleid, itemcode, quantity, unitprice, discount, serialno, taxtypeid, taxrate, description)
        SELECT $branchid, $id, itemcode, quantity, unitprice, discount, serialno, taxtypeid, taxrate, description
        FROM tempsale WHERE branchid = $branchid AND refno = $refno;
