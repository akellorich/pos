                                ...
                                <div class="card-body">
                                    <div class="form-group mb-3">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input" id="selectalldates" checked style="cursor: pointer;">
                                            <label class="custom-control-label font-weight-bold text-muted" for="selectalldates" style="font-size: 0.8rem; cursor: pointer; user-select: none; padding-left: 5px;">All Dates</label>
                                        </div>
                                    </div>
                        ...
                        <div class="containergroup card">
                            ...
                            <div class="card-body card-body-list">
                                ...
                                <div class="table-container">
                                    <table class="table table-striped table-sm mb-0" id="inputoutputvatreporttable">
                                        <thead>
                                            <th>#</th>
                                            <th>Item Code</th>
                                            <th>Item Name</th>
