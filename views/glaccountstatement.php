...
<html lang="en" dir="ltr">
  <head>
    ...
    <title> SalesFlow | GL Account Statement </title>
    <style>
      /* Responsive customizations for the GL Account Statement page */
...
<body>
    ...
    <section class="home-section">
        <?php $pagename = "GL Account Statement"; require_once("topbar.php"); ?>
                ...
                <div class="row">
                        ...
                        <div class="collapse d-lg-block" id="filterCollapse">
                            <div class="containergroup card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label for="glaccount" class="font-weight-bold text-muted" style="font-size: 0.8rem;">GL Account</label>
                                        <select id="glaccount" name="glaccount" class="form-control form-control-sm"></select>
                                    </div>

                                    <div class="d-flex justify-content-end mt-2">
                                        <button type="button" class="btn btn-secondary btn-sm" id="search" name="search" style="min-width: 150px; font-weight: 500;">
                                            <i class="fal fa-sync mr-2" style="font-size: 0.78rem;"></i>Generate Statement
                                        </button>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-12 col-lg-9" id="receiptlist">
                        <div class="containergroup card">
                            ...
                            <div class="card-body">
                                <div class="results table-container" id="results">
                                    <p class="alert alert-info mb-0">No results filtered yet</p>
                                </div>
                            </div>
                        </div>
                    </div>
