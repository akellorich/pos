...
<html lang="en" dir="ltr">
  <head>
    ...
    <style>
      /* Layout structure for Payments page: desktop vs mobile */
      ...
      /* Toggling filter panel */
      .payments-grid-layout.filters-hidden {
          grid-template-columns: 1fr !important;
      }
      .payments-grid-layout.filters-hidden .filter-wrapper {
 ...
 <body>
    ...
    <section class="home-section">
        <?php $pagename = "Payments"; require_once("topbar.php"); ?>
                    ...
                    <div class="containergroup card equal-height-card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between mt-3">
                                ...
                                <button class="btn btn-sm btn-success w-50" id="addnew"><i class="fas fa-plus-circle fa-fw fa-sm mr-1"></i> Add New</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="list-wrapper" id="receiptlist">
                    <div class="card containergroup equal-height-card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <button class="btn btn-outline-secondary btn-sm" id="toggle-filters" title="Toggle Filters">
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-container p-2 mt-2">
                                <table class='table table-striped table-sm mb-0 nowrap' id="results" style="width: 100%;">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td colspan='13' class="text-center text-muted py-4">No payments displayed. Apply filters and try again!</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
        ...
        <a href="paymentdetails.php" class="btn-floating-action d-lg-none" title="Add New" id="addnew-floating">
...
<script type="text/javascript" src="../js/paymentslist.js"></script>
</html>