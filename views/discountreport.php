...
<html lang="en" dir="ltr">
  <head>
    ...
    <style>
      /* Responsive customizations for the Discount Report page */
...
<body>
    ...
    <section class="home-section">
        <?php $pagename = "Discount Report"; require_once("topbar.php"); ?>
                        ...
                        <div class="containergroup card">
                            ...
                            <div class="card-body card-body-list">
                                ...
                                <div class="table-container">
                                    <table id="discountreport" class="table table-sm table-striped table-hover mb-0">
                                        <thead></thead>
                                        <tbody></tbody>
                                    </table>
                                </div>
