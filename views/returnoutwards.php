    ...
    <div class="container-fluid">
       <div class="row">
               ...
               <div class="containergroup card">
                   ...
                   <div class="card-body card-body-list">
                       <div id="filtererrors"></div>
                        ...
                        <button id="addreturninwards" class="btn btn-success btn-sm"><i class="fas fa-plus-circle fa-lg fa-fw"></i> Add Return Outwards</button>
                    </div>
               </div> 
           </div>
           ...
           <div class="col mt-2" id="receiptlist">
                <div class="containergroup card">
                    <div class="card-header">
                        <h5>Existing Returns Outwards</h5>
                    </div>
                    <div class="card-body card-body-list">
                        ...
                        <table class="table table-sm table-striped" id="existingreturnstable">
                            <thead>
                                ...
                                <th>Quantity</th>
                                <th>Line Total</th>
                                <th>&nbsp;</th> <!-- Add  Credit Note -->
                                <th>&nbsp;</th> <!-- Print the Rerturn Outwards Form -->
                            </thead>
                            <tbody></tbody>
                        </table>
                    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title">Return Outwards Details</h6>
                ...
                <div class="modal-body">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" class="form-control form-control-sm" placeholder="Enter GRN or Invoice Number" aria-label="Enter Purchase Receipt Number" aria-describedby="basic-addon2" id="receiptnumber" >
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-success btn-sm" id="savereturninward"> <i class="fas fa-save fa-lg fa-fw"></i> Save Return Outward</button>
                    <button type="button" class="btn btn-danger btn-sm" data-dismiss="modal"><i class="fas fa-times-circle  fa-lg fa-fw"></i> Close</button>
                </div>
            </div>
        </div>
    </div>
    <!-- Modal for capturing returned items  -->
    <div class="modal alert-dismissable fade" id="returncollectionmodal">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title">Item Receipt Details</h6>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-success btn-sm" id="savereturncollection"> <i class="fas fa-save fa-lg fa-fw"></i> Save Item Received</button>
                    <button type="button" class="btn btn-danger btn-sm" data-dismiss="modal"><i class="fas fa-times-circle  fa-lg fa-fw"></i> Close</button>
                </div>
            </div>
        </div>
...
<script type="text/javascript" src="../js/returnoutwards.js"></script>
</html>