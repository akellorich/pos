...
class payment extends db
{
    ...
    {
        $supplierid = (is_numeric($supplierid) && $supplierid > 0) ? intval($supplierid) : 0;
        $posid = (is_numeric($posid) && $posid > 0) ? intval($posid) : 0;
        $paymentmode = (is_numeric($paymentmode) && $paymentmode > 0) ? intval($paymentmode) : 0;
        $pettycashvouchers = ($pettycashvouchers == 1) ? 1 : 0;
