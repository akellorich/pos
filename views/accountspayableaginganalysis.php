...
<html lang="en" dir="ltr">
    <head>
        ...
        <style>
          /* Responsive customizations for the Payables Aging Analysis page */
                                ...
                                <div class="containergroup card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label for="startdate" class="font-weight-bold text-muted" style="font-size: 0.8rem;">AP Analysis As At</label>
                        ...
                        <div class="col-12 col-lg-9" id="receiptlist">
                            <div class="containergroup card">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h5>Accounts Payable Aging Analysis</h5>
