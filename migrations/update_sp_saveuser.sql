...
BEGIN
    IF $userid = 0 THEN 
        INSERT INTO `user`(
            clientid, username, password, salt, profilephoto, firstname, middlename, lastname, email, mobile, 
            changepasswordonlogon, accountactive, addedby, dateadded, systemadmin, pin, pinsalt
        ) VALUES (
            $clientid, $username, $userpassword, $salt, $profilephoto, $firstname, $middlename, $lastname, $email, $mobile, 
